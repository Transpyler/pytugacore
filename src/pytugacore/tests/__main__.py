...
from pytugacore import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('pytugacore')
...
def main(args=None):
    """
    Called with ``python -m pytugacore.tests``: run main test suite.
    """
    ...
    import pytugacore.tests as test_module
